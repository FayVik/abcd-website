  ...
  return (
    <div>
      ...
      <div className="flex flex-col xl:flex-row xl:py-20 justify-center bg-gradient-to-r from-blue-800 via-white to-blue-800">
        <AboutCard>
          ...
          <div class="p-8">
            ...
            <Paragraph>
              <a href="#" class="">
                We at ABCD are committed to continuous and groundbreaking tech
                growth in Africa
              </a>
            </Paragraph>
            <Paragraph>
              Women are the core of technological and we are all for Women
              empowerment.
            </Paragraph>
          </div>
        </AboutCard>
      ...
      <div className="p-5 lg:p-20 w-full md:w-5/6 lg:w-3/4 xl:w-1/2 mx-auto justify-center border-blue-800">
        ...
        <Paragraph>
          ABCD founders have been long involved in the development of
          initiatives related to the tech industry and blockchain in Nigeria and
          Africa.
        </Paragraph>

        <Paragraph>
          To do so, we have reviewed some of our initial objectives, perhaps too
          ambitious, in order to arrive at a roadmap that is still ambitious but
        ...
        <ul className="text-2xl my-3">
          ...
          <li>
            Contribute to the rise of blockchain technologies and
          ...
          <li>
            Address, thanks to decentralization, some of the most pressing
            issues in Africa (ID systems, land registration, blood donation,
            access to property, traceability, etc.)
          </li>
        </ul>

        <Paragraph>
          Together with the Cardano Community and in particular with African
          entities such as Gimbalabs, WADA, IOG Africa and African SPOs, ABCD
          will create, develop and provide open source materials for new and
          emerging technology specializing in the development of core Cardano
          blockchain technologies and applications. In both the immediate and
          long terms, ABCD will facilitate enhanced economic health in Africa
          while promoting an encouraging adoption of Cardano and blockchain
          technologies throughout the continent.
        </Paragraph>

        <Paragraph>
          These achievements will be self-reinforcing: by increasing the
          successful development of emerging businesses in the Cardano
          blockchain ecosystem, we will create value and new investment
          opportunities. By providing training, mentorship, shared space, and
          professional assistance, we will build a network of experts who will
          be able to share their expertise with additional developers. By
          incubating businesses, ABCD will move out into the community and
          contribute to the overall vitality, diversity, and growth of Cardano
          in the booming African economy.
        </Paragraph>

        <Paragraph>
          ABCD will provide an environment that allows Africans to take an
          active role in "growing their own" businesses that will lead to job
          creation. These new businesses and new jobs produced create wealth
