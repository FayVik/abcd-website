...
function about() {
    return (
        <div className="bg-about-smile bg-cover h-screen p-20">
            <div className="bg-blue-400 bg-opacity-50 w-1/2 h-96 pt-5">
                <section className="m-5">
                    ...
                    <p className="text-lg">empowering the African woman for greater exploits...</p>
                </section>
                <section className="mx-5 my-10">
                    <Link href="/">
                        <a className="bg-blue-700 hover:bg-blue-100 text-white hover:text-blue-700 p-5 rounded-lg">Learn more</a>
                    </Link>   
                </section>
            </div>
